        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultMfaProvider = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StackTrace = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TranscationId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleProduct", x => new { x.SalesId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName", "Priority" },
                values: new object[,]
                {
                    { "1d2a6ea6-0776-43e8-b41f-8fd71c50271a", "864bfd49-b615-44e3-8913-8e8a1828d3dc", "Super Admin", "SUPER ADMIN", 1 },
                    { "3f3c9d8e-3f3e-441a-82d8-0290a3744d0d", "3553e99a-3949-46fb-9db7-68de70e7ad63", "Admin", "Admin", 2 },
                    { "ae888c3b-d184-4562-a2b7-97e9e67e81c9", "0bb65ffc-d232-4598-b0c8-b536d764fb15", "User", "USER", 2 }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "DefaultMfaProvider", "Email", "EmailConfirmed", "FirstName", "Gender", "IsActive", "LastName", "LastUpdatedAt", "LastUpdatedBy", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "Token", "TwoFactorEnabled", "UserName" },
                values: new object[] { "b022ddbd-03b2-4afd-a100-e345d23e62c0", 0, "46cc681c-42d9-4b39-b7f5-dade9544c05a", 0, "achyut@techglazers.com", true, "Achyut", 0, true, "Gaihre", new DateTimeOffset(new DateTime(2022, 12, 31, 5, 49, 5, 819, DateTimeKind.Unspecified).AddTicks(5132), new TimeSpan(0, 0, 0, 0, 0)), "SA", false, null, "ACHYUT@TECHGLAZERS.COM", "ACTOP", null, "9000000000", false, "9a31a1a1-c420-4a4f-b16d-f238687e01f2", null, false, "actop" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "1d2a6ea6-0776-43e8-b41f-8fd71c50271a", "b022ddbd-03b2-4afd-a100-e345d23e62c0" });
