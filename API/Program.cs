...
builder.Services.Configure<FtpConfiguration>(configuration.GetSection(FtpConfiguration.SECTION_NAME));
...
builder.Services.AddScoped<IIMSDbContext>(provider =>
    provider.GetService<IMSDbContext>());
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Version = "v1",
        Title = $"IMS - {builder.Environment.EnvironmentName}"
    });
